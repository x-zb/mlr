...
from peach.enc_utils.enc_learners import LearnerMixin, PromptedLearnerMixin, PrefixedLearnerMixin
...
class PrefixedDenseLearner(PrefixedLearnerMixin):
    ...
    def compute_loss(self, emb_doc, emb_query):
        ...
        if self.model_args.do_xentropy:
            ...
            dict_for_meta['dense_ib_similarities'] = dense_ib_similarities # (bsz,bsz*num_doc*num_ranks)
            dict_for_meta['xentropy_target'] = xentropy_target # (bsz)
