...
from proj_dense.beir_eval.sentence_transformer_beir import SentenceBERTForBEIR
...
def main(args):
    ...
    out_dir = os.path.join(pathlib.Path(__file__).parent.absolute(), "..", "..", "..", "data", "beir")
    # data_path = util.download_and_unzip(url, out_dir)
    data_path = out_dir+'/'+args.dataset
