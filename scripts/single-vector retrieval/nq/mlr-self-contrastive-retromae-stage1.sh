...
accelerate launch --multi_gpu --mixed_precision=no --num_processes=4 \
	...
	--output_dir "results_nq/dmde2_1210_hybreg01_lr6_e40_mae1" \
	--max_length 256 --logging_steps 100 --eval_batch_size 32  \
	--data_load_type "memory" --num_proc 16 \
	--evaluation_strategy "epoch" --seed 12345 \
	--learning_rate 5e-6 --num_train_epochs 40 --train_batch_size 128 --chunk_size 16 \
	...
	> nq_run_dmde2_1210_hybreg01_lr6_e40_mae1.out 2>&1
...
for _id in $(seq 0 $((${NUM_SHARDS}-1))); do
	...
	--num_machines=1 --dynamo_backend=no -m proj_dense.train_dense_retriever \
		--task "nq" \
		--model_name_or_path "results_nq/dmde2_1210_hybreg01_lr6_e40_mae1/last_checkpoint" \
		...
		--max_length 256 \
		--eval_batch_size 128  \
		> nq_pred_dmde2_1210_hybreg01_lr6_e40_mae1_${_id}.out 2>&1
done	
...
accelerate launch --multi_gpu --mixed_precision=no --num_processes=4 \
	...
	--eval_batch_size 128 \
	--hits_num 100 \
	> nq_pred_dmde2_1210_hybreg01_lr6_e40_mae1.out 2>&1
...
accelerate launch --multi_gpu --mixed_precision=no --num_processes=4 \
	...
	--eval_batch_size 128 \
	--hits_num 100 \
	> nq_pred_dmde2_1210_hybreg01_lr6_e40_mae1_trainset.out 2>&1
...
accelerate launch --multi_gpu --mixed_precision=no --num_processes=4 \
	...
	--prediction_source "train" \
	--hn_gen_num 100 \
	> nq_pred_dmde2_1210_hybreg01_lr6_e40_mae1_hngen.out 2>&1
