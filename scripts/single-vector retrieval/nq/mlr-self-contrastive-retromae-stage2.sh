...
accelerate launch --multi_gpu --mixed_precision=no --num_processes=4 \
	...
	--output_dir "results_nq/dmde2_1210_hybreg01_lr6_e20_mae2" \
	...
	> nq_run_dmde2_1210_hybreg01_lr6_e20_mae2.out 2>&1
...
for _id in $(seq 0 $((${NUM_SHARDS}-1))); do
	...
	--num_machines=1 --dynamo_backend=no -m proj_dense.train_dense_retriever \
		--task "nq" \
		--model_name_or_path "results_nq/dmde2_1210_hybreg01_lr6_e20_mae2/last_checkpoint" \
		...
		--max_length 256 \
		--eval_batch_size 128  \
		> nq_pred_dmde2_1210_hybreg01_lr6_e20_mae2_${_id}.out 2>&1
done	
...
accelerate launch --multi_gpu --mixed_precision=no --num_processes=4 \
	...
	--eval_batch_size 128 \
	--hits_num 100 \
	> nq_pred_dmde2_1210_hybreg01_lr6_e20_mae2.out 2>&1